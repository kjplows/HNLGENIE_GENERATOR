...
// HNL with various masses
const int kPdgHNLHeavy0    =  1901;
const int kPdgHNLBarHeavy0 = -1901;
const int kPdgHNLHeavy1    =  1902;
const int kPdgHNLBarHeavy1 = -1902;
const int kPdgHNLHeavy2    =  1903;
const int kPdgHNLBarHeavy2 = -1903;
const int kPdgHNLHeavy3    =  1904;
const int kPdgHNLBarHeavy3 = -1904;
const int kPdgHNLHeavy4    =  1905;
const int kPdgHNLBarHeavy4 = -1905;
const int kPdgHNLHeavy5    =  1906;
const int kPdgHNLBarHeavy5 = -1906;
const int kPdgHNLHeavy6    =  1907;
const int kPdgHNLBarHeavy6 = -1907;
const int kPdgHNLHeavy7    =  1908;
const int kPdgHNLBarHeavy7 = -1908;
const int kPdgHNLHeavy8    =  1909;
const int kPdgHNLBarHeavy8 = -1909;
const int kPdgHNLHeavy9    =  1910;
const int kPdgHNLBarHeavy9 = -1910;
const int kPdgHNLHeavyA    =  1911;
const int kPdgHNLBarHeavyA = -1911;
const int kPdgHNLHeavyB    =  1912;
const int kPdgHNLBarHeavyB = -1912;
const int kPdgHNLHeavyC    =  1913;
const int kPdgHNLBarHeavyC = -1913;
const int kPdgHNLHeavyD    =  1914;
const int kPdgHNLBarHeavyD = -1914;
const int kPdgHNLHeavyE    =  1915;
const int kPdgHNLBarHeavyE = -1915;
const int kPdgHNLHeavyF    =  1916;
const int kPdgHNLBarHeavyF = -1916;
const int kPdgHNLHeavyG    =  1917;
const int kPdgHNLBarHeavyG = -1917;
const int kPdgHNLHeavyH    =  1918;
const int kPdgHNLBarHeavyH = -1918;
const int kPdgHNLHeavyI    =  1919;
const int kPdgHNLBarHeavyI = -1919;
const int kPdgHNLHeavyJ    =  1920;
const int kPdgHNLBarHeavyJ = -1920;
