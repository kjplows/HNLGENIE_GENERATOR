...
namespace HNL {
	...
	*/
	...
	static std::map< massHyp_t, double > massHypMap = std::map< massHyp_t, double > {
	    { kInitHyp,      -1.000 * gu::keV },
	    { kLight0Hyp,     1.000 * gu::keV },
	    { kLight1Hyp,    10.000 * gu::keV },
	    { kLight2Hyp,   100.000 * gu::keV },
	    { kLight3Hyp,   500.000 * gu::keV },
	    { kLight4Hyp,     1.000 * gu::MeV },
	    { kLight5Hyp,     5.000 * gu::MeV },
	    { kLight6Hyp,    10.000 * gu::MeV },
	    { kLight7Hyp,    15.000 * gu::MeV },
	    { kLight8Hyp,    20.000 * gu::MeV },
	    { kLight9Hyp,    25.000 * gu::MeV },
	    { kLightAHyp,    30.000 * gu::MeV },
	    { kLightBHyp,    33.000 * gu::MeV },
	    { kLightCHyp,    35.000 * gu::MeV },
	    { kLightDHyp,    40.000 * gu::MeV },
	    { kLightEHyp,    45.000 * gu::MeV },
	    { kLightFHyp,    50.000 * gu::MeV },
	    { kLightGHyp,    60.000 * gu::MeV },
	    { kLightHHyp,    70.000 * gu::MeV },
	    { kLightIHyp,    80.000 * gu::MeV },
	    { kLightJHyp,    90.000 * gu::MeV },
	    { kMedium0Hyp,  100.000 * gu::MeV },
	    { kMedium1Hyp,  114.523 * gu::MeV },
	    { kMedium2Hyp,  129.046 * gu::MeV },
	    { kMedium3Hyp,  143.569 * gu::MeV },
	    { kMedium4Hyp,  158.092 * gu::MeV },
	    { kMedium5Hyp,  172.614 * gu::MeV },
	    { kMedium6Hyp,  187.137 * gu::MeV },
	    { kMedium7Hyp,  201.660 * gu::MeV },
	    { kMedium8Hyp,  216.183 * gu::MeV },
	    { kMedium9Hyp,  230.706 * gu::MeV },
	    { kHeavy0Hyp,   245.229 * gu::MeV },
	    { kHeavy1Hyp,   260.983 * gu::MeV },
	    { kHeavy2Hyp,   276.738 * gu::MeV },
	    { kHeavy3Hyp,   292.492 * gu::MeV },
	    { kHeavy4Hyp,   308.246 * gu::MeV },
	    { kHeavy5Hyp,   324.001 * gu::MeV },
	    { kHeavy6Hyp,   339.755 * gu::MeV },
	    { kHeavy7Hyp,   355.510 * gu::MeV },
	    { kHeavy8Hyp,   371.264 * gu::MeV },
	    { kHeavy9Hyp,   387.019 * gu::MeV },
	    { kHeavyAHyp,   397.434 * gu::MeV },
	    { kHeavyBHyp,   407.948 * gu::MeV },
	    { kHeavyCHyp,   418.626 * gu::MeV },
	    { kHeavyDHyp,   428.978 * gu::MeV },
	    { kHeavyEHyp,   439.493 * gu::MeV },
	    { kHeavyFHyp,   450.007 * gu::MeV },
	    { kHeavyGHyp,   460.622 * gu::MeV },
	    { kHeavyHHyp,   471.137 * gu::MeV },
	    { kHeavyIHyp,   481.652 * gu::MeV },
	    { kHeavyJHyp,   492.166 * gu::MeV } 
	};
