...
simple-hnl: FORCE
ifeq ($(strip $(GOPT_ENABLE_SIMPLE_HNL)),YES)
	@echo " "
	@echo "** Building SimpleHNL extension..."
	cd ${GENIE}/src/SimpleHNL && \
	$(MAKE) && \
	cd ${GENIE}
else
	@echo " "
	@echo "** The SimpleHNL extension was not enabled. Skipping..."
endif
...
make-install-dirs: FORCE
	...
	mkdir ${GENIE_INC_INSTALLATION_PATH}/SimpleHNL
...
distclean: FORCE
	...
	cd SimpleHNL &&                      $(MAKE) distclean && cd .. && \
